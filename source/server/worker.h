...
public:
  ...
  void addListenerNonThreadSafe(ListenerSharedPtr listener);
  void addListenerThreadSafe(ListenerSharedPtr listener);
  void removeListener(ListenerSharedPtr listener);
